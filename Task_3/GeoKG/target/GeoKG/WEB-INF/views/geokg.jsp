...
<layout:extends name="base">
    ...
    <layout:put block="content" type="REPLACE">
        <div class="clearfix">
            <div class="query col-md-4 float-left">
                    <%--TDB--%>
                <form >
            ...
            <div class="col-md-8 float-left" style="overflow: hidden">
                <div id="myChart" class="graph" style="border: 1px solid #3b8686; border-radius: 5px;width: 700px;height: 500px;"></div>
            </div>
        </div>
    </layout:put>
    <layout:put block="footer" type="APPEND">
        <script type="text/javascript" src="<c:url value="app/js/echarts.min.js"/> "></script>
        <script type="text/javascript" src="<c:url value="app/js/jquery-3.3.1.min.js"/> "></script>
